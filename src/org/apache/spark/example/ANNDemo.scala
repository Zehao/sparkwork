...
object ANNDemo {
  ...
  def main(arg: Array[String]) {
    ...
    println("Training 2D")
    var model2D = ArtificialNeuralNetwork.train(testRDD2D, Array[Int](5, 3), 3000, 1e-8)
    ...
    //val res = predictedAndTarget2D.map(T => (T._2.toArray(0) , T._3.toArray(0) ))

    //predictedAndTarget2D.foreach(T => println(T._2.toArray(0) , T._3.toArray(0)))
